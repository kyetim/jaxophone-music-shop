            ...
            >
                ...
                {favoriteItems.length === 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center flex-1 p-6">
                        ...
                        <h3 className="text-lg font-medium text-gray-900 mb-2">Favorileriniz Boş</h3>
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex justify-between items-start mb-1">
                                                <div className="min-w-0 flex-1">
                                                    <Link href={`/products/${item.id}`} onClick={onClose}>
                                                        <h4 className="font-medium text-xs text-gray-900 truncate leading-tight hover:text-amber-600 transition-colors cursor-pointer">
                                                            {item.name}
                                                        </h4>
                                                    </Link>
                                                ...
                                                <Button
                                                    ...
                                                    className="text-gray-400 hover:text-red-600 h-5 w-5 flex-shrink-0 ml-1 cursor-pointer"
                                                >
                                                    <X className="h-3 w-3" />
                                                </Button>
                                            </div>
                            ...
                            <div className="p-4 space-y-3">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Button
                                        variant="outline"
                                        onClick={handleClearFavorites}
                                        className="w-full border-red-300 text-red-700 hover:bg-red-50 py-2 cursor-pointer"
                                    >
                                        Favorileri Temizle
                                    </Button>
                                </div>
