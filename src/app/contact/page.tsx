                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 dark:text-gray-300 mt-1">
                                            <a href="tel:08509557777" className="hover:text-amber-600 dark:hover:text-amber-400 transition-colors">
                                                0 850 955 77 77
                                            </a>
                                        </p>
                                        <p className="text-gray-600 dark:text-gray-300">
                                            <a href="tel:+902123456789" className="hover:text-amber-600 dark:hover:text-amber-400 transition-colors">
                                                +90 212 345 67 89
                                            </a>
                                        </p>
                                    </div>
                                ...
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 dark:text-gray-300 mt-1">
                                            <a href="mailto:info@jaxophone.com" className="hover:text-amber-600 dark:hover:text-amber-400 transition-colors">
                                                info@jaxophone.com
                                            </a>
                                        </p>
                                        <p className="text-gray-600 dark:text-gray-300">
                                            <a href="mailto:destek@jaxophone.com" className="hover:text-amber-600 dark:hover:text-amber-400 transition-colors">
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-8 border border-gray-200 dark:border-gray-800">
                            <div className="flex items-center space-x-3 mb-6">
                                ...
                                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Bize Yazın</h2>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        required
                                        rows={6}
                                        className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 resize-none"
                ...
                <div className="mt-12">
                    <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-8 border border-gray-200 dark:border-gray-800">
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Konumumuz</h2>
                            <button
                        ...
                        {mapError ? (
                            <div className="w-full h-96 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center border border-gray-300 dark:border-gray-700">
                                <div className="text-center">
                                    <MapPin className="h-16 w-16 text-gray-400 mx-auto mb-4" />
                                    <p className="text-gray-700 dark:text-gray-300 mb-2 font-medium">Harita Yüklenemedi</p>
                                    ...
                                    <div className="mt-6">
                                        <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">Alternatif harita:</p>
                                        <iframe
                            ...
                            <div className="relative">
                                ...
                                />
                                {!mapLoaded && (
                                    <div className="absolute inset-0 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center border border-gray-300 dark:border-gray-700">
                                        <div className="text-center">
                                            <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-amber-400 mx-auto mb-2"></div>
                                            <p className="text-gray-700 dark:text-gray-300">Harita yükleniyor...</p>
                                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Bu işlem birkaç saniye sürebilir</p>
                                        </div>
                                    </div>
                                )}
                            </div>
